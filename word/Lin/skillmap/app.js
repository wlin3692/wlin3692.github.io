document.addEventListener('DOMContentLoaded', () => {
  const STORAGE_KEY = 'xiaolin-skill-map-v2';
  ...
  const defaultNodes = [
    ...
    { id: 4, parent: 1, type: 'crypto' },
    { id: 5, parent: 2, type: 'cms' },
    { id: 6, parent: 3, type: 'appleSort' },
    { id: 7, parent: 3, type: 'smartCar' },
    { id: 8, parent: 4, type: 'sm3' },
    { id: 9, parent: 1, type: 'audit' },
    { id: 10, parent: 2, type: 'blueTeam' },
    { id: 11, parent: 3, type: 'certifications' }
  ];
