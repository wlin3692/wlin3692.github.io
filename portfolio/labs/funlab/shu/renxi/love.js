(function(window){
    ...
    var Point = window.Point = function(x, y) {
        this.x = x || 0;
        this.y = y || 0;
    }
    Point.prototype = {
    ...
    var Seed = window.Seed = function(tree, point, scale, color) {
        this.tree = tree;
    ...
    Seed.prototype = {
        ...
        clear: function() {
            ...
            var w = radius * scale, h = radius * scale;
    ...
    var Footer = window.Footer = function(tree, width, height, speed) {
        this.tree = tree;
    ...
    var Tree = window.Tree = function(canvas, width, height, opt) {
        this.canvas = canvas;
    ...
    var Branch = window.Branch = function(tree, point1, point2, point3, radius, length, branchs) {
        this.tree = tree;
        this.point1 = point1;
        this.point2 = point2;
        this.point3 = point3;
    ...
    var Bloom = window.Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        this.tree = tree;
        this.point = point;
